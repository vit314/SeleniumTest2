...
public class HomePage extends Base {
  ...
  private By sortAtoZButton = By.xpath("//select[@class='product_sort_container']//option[@value='za']");
  private By sortZtoAButton = By.xpath("//select[@class='product_sort_container']//option[@value='az']");
  private By sortPriceLowToHigh = By.xpath("//select[@class='product_sort_container']//option[@value='hilo']");
  private By sortPriceHighToLow = By.xpath("//select[@class='product_sort_container']//option[@value='lohi']");
  private By sidebarButton = By.xpath("//div[@class='bm-burger-button']");
  private By allItemsLink = By.xpath("//a[@id='inventory_sidebar_link']");
  private By aboutLink = By.xpath("//a[@id='about_sidebar_links']");
  ...
  private By itemsPrice = By.xpath("//div[@class='inventory_item_prices']");
  ...
  //"Click on the name of the Sauce Labs Backpack product item")
  public void clickSauceLabsBackpack() {
    driver.findElement(sauceLabsBackpack).click();
  }

  //"Click \"ADD TO CART\" button on the Sauce Labs Backpack product item on the Home page")
  public void clickAddCartSauceLabsBackpackButton() {
    driver.findElement(addCartSauceLabsBackpackToCartButton).click();
  }

  //"Click \"Cart\" icon on the Home page")
  public void clickCartButton() {
    driver.findElement(cartButton).click();
  }

  //"Add all product items to cart by clicking \"ADD TO CART\" button near each product on the Home page")
  ...
  //"Click \"Name A to Z\" button in the dropdown list to sort product items from A to Z by alphabetic")
  ...
  //"Click \"Name Z to A\" button in the dropdown list to sort product items from A to Z by alphabetic")
